...
public class BlueCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public BlueCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.WATER_BREATHING, 100, 5, false, false));
