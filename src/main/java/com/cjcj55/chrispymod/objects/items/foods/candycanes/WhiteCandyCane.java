...
public class WhiteCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public WhiteCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.SLOW_FALLING, 100, 5, false, false));
