...
public class PurpleCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public PurpleCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.LEVITATION, 100, 5, false, false));
