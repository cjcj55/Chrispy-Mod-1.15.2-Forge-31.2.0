...
public class DistancePickaxe extends PickaxeItem {

	public DistancePickaxe(Properties properties) {
	...
	public void appendHoverText(ItemStack stack, Level level, List<Component> list, TooltipFlag flags) {
		...
		list.add(new TranslatableComponent("message.distancepick.tooltip", Integer.toString(distance)).withStyle(ChatFormatting.YELLOW));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
		...
		if (level.isClientSide()) {
			player.sendMessage(new TranslatableComponent("message.distancepick.change", Integer.toString(distance)), Util.NIL_UUID);
		}
