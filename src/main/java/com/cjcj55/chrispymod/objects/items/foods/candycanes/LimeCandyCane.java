...
public class LimeCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public LimeCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.NAUSEA, 100, 5, false, false));
