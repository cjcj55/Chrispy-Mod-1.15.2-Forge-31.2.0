...
public class OrangeCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public OrangeCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.GLOWING, 100, 5, false, false));
