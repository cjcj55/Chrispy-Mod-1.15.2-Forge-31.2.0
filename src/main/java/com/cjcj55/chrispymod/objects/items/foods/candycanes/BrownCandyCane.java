...
public class BrownCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public BrownCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.HUNGER, 100, 5, false, false));
