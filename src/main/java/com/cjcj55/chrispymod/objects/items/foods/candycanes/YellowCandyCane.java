...
public class YellowCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public YellowCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.ABSORPTION, 100, 1, false, false));
