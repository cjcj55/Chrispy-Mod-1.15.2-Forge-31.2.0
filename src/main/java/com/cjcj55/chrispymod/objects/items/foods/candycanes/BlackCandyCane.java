...
public class BlackCandyCane extends ChrispyItemFoodAlwaysEdible
{	
	public BlackCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
	...
	{	
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.BLINDNESS, 100, 5, false, false));
