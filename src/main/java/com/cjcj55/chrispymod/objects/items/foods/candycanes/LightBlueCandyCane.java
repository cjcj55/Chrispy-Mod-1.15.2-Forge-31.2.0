...
public class LightBlueCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public LightBlueCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.DOLPHINS_GRACE, 100, 5, false, false));
