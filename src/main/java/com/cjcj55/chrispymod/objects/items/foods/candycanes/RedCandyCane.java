...
public class RedCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public RedCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.INSTANT_HEALTH, 100, 1, false, false));
