...
public class GrayCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public GrayCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.MINING_FATIGUE, 200, 5, false, false));
