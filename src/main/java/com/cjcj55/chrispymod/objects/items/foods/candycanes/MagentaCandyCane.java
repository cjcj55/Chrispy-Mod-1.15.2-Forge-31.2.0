...
public class MagentaCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public MagentaCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.INSTANT_DAMAGE, 100, 4, false, false));
