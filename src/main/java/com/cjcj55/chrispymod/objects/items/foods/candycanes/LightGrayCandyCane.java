...
public class LightGrayCandyCane extends ChrispyItemFoodAlwaysEdible
{
	public LightGrayCandyCane(String name, int hunger, float saturation, boolean alwaysEdible)
    {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving)
	{
        ...
        {
        	entityLiving.addPotionEffect(new EffectInstance(Effects.INVISIBILITY, 100, 5, false, false));
